...
public class infiniteWorld : MonoBehaviour
{
    ...
    [SerializeField] int terrainTileHorizontalCount = 10; // Initialize with some default value
    [SerializeField] int terrainTileVerticalCount = 10;   // Initialize with some default value
